...
public class ExampleUnitTest {
    ...
    public void addition_isCorrect() throws Exception {
        ...
        for (Class<?> clz : getClasses("android.databinding.adapters")) {
    ...
    private void tes(Class... classes) {
        for (Class clz : classes) {
            for (Method method : clz.getDeclaredMethods()) {
                Modifier.isStatic(method.getModifiers()); // 是否是静态
                Modifier.isPublic(method.getModifiers()); // 是否是public

                if (method.isAnnotationPresent(BindingAdapter.class)) {
